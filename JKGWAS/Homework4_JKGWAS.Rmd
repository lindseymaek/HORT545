...
X=X[,-1];
set.seed(99)
mySim=GAPIT.Phenotype.Simulation(GD=X,GM=SNP,h2=.75,NQTN=10, effectunit =.95,QTNDist="normal",CV=CV);

myGAPIT_BLINK = GAPIT(Y=mySim$Y,GD=X,GM=SNP, CV=CV, PCA.total = 3, QTN.position = mySim$QTN.position, model = "Blink",file.output = F)      ## GWAS with Blink
